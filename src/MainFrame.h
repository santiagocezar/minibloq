...
// MainFrame
//////////////////////////////////////////////////////////////////////
class MainFrame : public wxFrame, public BubbleEventHandler
{
    private:
...
*/
    ...
    public:
        ...
        //inline void setBoardName(const wxString& value) { boardName = value; }
        inline wxString getBoardName() const { return boardName; }
